...
$DOCKER run --device nvidia.com/gpu=all --security-opt=label=disable -p 8888:8888 -v $volume:/data -v $scriptvolume:/app -it localhost/trieder83/com-transate:gpu-0.2  flask --app translate_nllb.py run --host 0.0.0.0 --port 8888 
